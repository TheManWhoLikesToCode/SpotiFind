...
plt.figtext(0.5, 0.01, 
            "This plot visualizes the similarity between different Spotify tracks based on their audio features. "
            "Each point represents a track, and tracks that are closer together in the plot are more similar in terms of their audio features. "
            "The plot uses t-SNE (t-Distributed Stochastic Neighbor Embedding), a machine learning algorithm for visualization, to reduce the dimensionality of the data to two dimensions. "
            "The colors represent different clusters of tracks created using KMeans clustering.", 
